...
import Aimage from "../img/maintenanceA.png";
  ...
  return (
    <div className="relative font-noto min-w-[320px] tracking-wider scroll-smooth">
      ...
      <div className="w-full mt-10 min-w-[320px]">
        <div className="w-full flex flex-col xl:flex-row justify-center items-center px-9%">
          ...
          <img className="py-20" src={Aimage} alt="" />
        </div>
        <div className="translate-y-1.5 px-5% pt-10 pb-10 bg-main-darkgreen text-white text-center">
          本網站僅為練習使用，參考網頁:
          <a
            className="underline"
