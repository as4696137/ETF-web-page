...
function Icon() {
  ...
  const envelopes = [
    ...
    <Envelope2 key="envelope2" />,
    <Envelope3 key="envelope3" />,
    <Envelope4 key="envelope4" />,
  ];
  ...
  const aninatedEnvelopes = springs.map((animatedStyle, index) => (
  ...
  return (
    <>
      <button
        className="border hover:bg-slate-300 active:bg-slate-400 rounded"
        type="button"
        onClick={() => {
          setToggle(!toggle);
        }}
      ...
      >
        ...
        <path
          ...
          d="M346.26 400.92H420.68V728.97H346.26z"
        ></path>
        <path
          fill="#eceff1"
          d="M353.11 400.92H415.78000000000003V723.1H353.11z"
        ></path>
        <path
        ...
        <path
          ...
          d="M502.94 125.75L456.43 125.75 428.52 125.75 428.52 181.06 428.52 249.13 462.3 249.13 462.3 181.06 502.94 181.06 502.94 125.75z"
        ></path>
        <path
          fill="#ffcc80"
          d="M497.06 125.75L457.89 125.75 434.39 125.75 434.39 176.67 434.39 239.34 457.89 239.34 457.89 176.67 497.06 176.67 497.06 125.75z"
        ></path>
        ...
        <path
          ...
          d="M657.37 70.58L654.4 72.03 654.74 71.42 654.48 71.5 654.85 71.23 694.87 0 715.33 17.45 732.89 33.7 727.85 36.16 733.51 46.15 657.37 70.58z"
        ></path>
        <path
          fill="#6c63ff"
        ...
        <path
          fill="#6c63ff"
          d="M694.59 3.35L656.63 70.34 713.31 19.31 694.59 3.35z"
        ></path>
        <path
          fill="#6c63ff"
          d="M729.82 45.7L656.71 69.85 717.82 24.23 729.82 45.7z"
        ></path>
        <path
          fill="url(#72adf1b2-6031-4d64-80db-157af34e8b1b)"
          d="M121.67 86.97L126.45 87.71 125.71 87.01 126.12 87.01 125.48 86.79 38.62 4.42 17.54 37.69 0 68.04 8.12 69.3 4.52 85.74 121.67 86.97z"
        ></path>
        <path
          fill="#6c63ff"
          d="M21.18 39.42L5.16 67.19 122.6 86.31 46.96 33.64 21.18 39.42z"
        ></path>
        <path
          d="M21.18 39.42L5.16 67.19 122.6 86.31 46.96 33.64 21.18 39.42z"
          opacity="0.2"
        ...
        <path
          fill="#6c63ff"
          d="M40.47 8.99L122.6 86.31 21.18 39.42 40.47 8.99z"
        ></path>
        <path
          fill="#6c63ff"
          d="M9.49 83.51L122.28 85.67 16.99 48.27 9.49 83.51z"
        ></path>
      </svg>
    </>
  );
